...
namespace TypedQuery.Logic {
	...
	public static class CodeGenerator {
		...
		public static string GenerateTableAndRowCode(ITableDetails pTableDetails, ref string pColumnPrefix, bool pIncludeSchema, bool pGuessPrefix, bool pGenerateComments) {
			...
			for(int columnIndex = 0; columnIndex < pTableDetails.Columns.Count; columnIndex++) {
				...
				code.Append(tab).Append(tab).Append("public ").Append(GetColumnType(column, pTableDetails)).Append(" ").Append(FormatName(GetColumnName(column, pColumnPrefix))).Append(" { get; private set; }").Append(endl);
			}
			...
			for(int columnIndex = 0; columnIndex < pTableDetails.Columns.Count; columnIndex++) {
				...
				code.Append(tab).Append(tab).Append(tab).Append(FormatName(GetColumnName(column, pColumnPrefix))).Append(" = new ").Append(GetColumnType(column, pTableDetails)).Append("(this, \"").Append(column.ColumnName).Append("\", ").Append(primaryKey);
			...
			for(int columnIndex = 0; columnIndex < pTableDetails.Columns.Count; columnIndex++) {
				...
				if(columnIndex > 0)
					code.Append(", ");
				code.Append(FormatName(GetColumnName(column, pColumnPrefix)));
			}
			...
			for(int columnIndex = 0; columnIndex < pTableDetails.Columns.Count; columnIndex++) {
				...
				string columnName = FormatName(GetColumnName(column, pColumnPrefix));
		...
		public static string GenerateClassCode(ITableDetails pTableDetails, string pColumnPrefix) {
			...
			for(int columnIndex = 0; columnIndex < pTableDetails.Columns.Count; columnIndex++) {
				...
				code.Append(tab).Append(tab).Append("public ").Append(GetReturnType(column.DbType, column.IsNullable)).Append(" ").Append(FormatName(GetColumnName(column, pColumnPrefix))).Append(" { get;");
			...
			for(int columnIndex = 0; columnIndex < pTableDetails.Columns.Count; columnIndex++) {
				...
				IColumn column = pTableDetails.Columns[columnIndex];
				string fieldName = FormatName(GetColumnName(column, pColumnPrefix));
		...
		private static string GetColumnName(IColumn pColumn, string pColumnPrefix) {
