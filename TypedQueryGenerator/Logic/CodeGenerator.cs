...
namespace TypedQuery.Logic {
	...
	public static class CodeGenerator {
		...
		public static string GenerateTableAndRowCode(ITableDetails pTableDetails, string pNamespace, ref string pColumnPrefix, bool pIncludeSchema, bool pGuessPrefix, bool pGenerateComments, bool pRemoveUnderscores) {
			...
			code.Append("using System;").Append(endl).Append(endl);
		...
		public static string GenerateClassCode(ITableDetails pTableDetails, string pNamespace, string pColumnPrefix, bool pRemoveUnderscores) {
