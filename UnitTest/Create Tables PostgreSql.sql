...
CREATE TABLE NGuidKeyTestTable (
	Id UUID NULL PRIMARY KEY
);

CREATE TABLE NInt64KeyTestTable (
	Id INT8 NULL PRIMARY KEY
);

CREATE TABLE NInt32KeyTestTable (
	Id INT4 NULL PRIMARY KEY
);

CREATE TABLE NInt16KeyTestTable (
	Id INT2 NULL PRIMARY KEY
);

CREATE TABLE NStringKeyTestTable (
