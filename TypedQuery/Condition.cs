...
namespace Sql {
    ...
    public abstract class Condition {
        ...
        public static Condition And(Condition pConditionA, Condition pConditionB) {
            return pConditionA != null ? new AndCondition(pConditionA, pConditionB) : pConditionB;
        }
        ...
        public static Condition Or(Condition pConditionA, Condition pConditionB) {
            return pConditionA != null ? new OrCondition(pConditionA, pConditionB) : pConditionB;
        }
