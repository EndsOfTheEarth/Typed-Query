...
namespace Sql.Column {
	...
	public class SmallIntegerKeyColumn<TABLE> : ANumericColumn where TABLE : ATable {
		...
		public static Condition operator ==(SmallIntegerKeyColumn<TABLE> pColumnA, Int16 pValue) {
		...
		public static NumericCondition<SmallIntegerKeyColumn<TABLE>, NSmallIntegerKeyColumn<TABLE>, Int16> operator +(SmallIntegerKeyColumn<TABLE> pColumnA, Int16 pValue) {
