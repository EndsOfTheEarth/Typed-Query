...
namespace Sql.Column {
    ...
    /// </summary>
    public class NDateTimeColumn : AColumn {

        public NDateTimeColumn(ATable pTable, string pColumnName)
            : base(pTable, pColumnName, false, true) {
        }
        public NDateTimeColumn(ATable pTable, string pColumnName, bool pIsPrimaryKey)
            : base(pTable, pColumnName, pIsPrimaryKey, true) {
        }

        public static Condition operator ==(NDateTimeColumn pColumnA, DateTimeColumn pColumnB) {
            return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
        }
        public static Condition operator ==(NDateTimeColumn pColumnA, NDateTimeColumn pColumnB) {
            return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
        }
        public static Condition operator ==(NDateTimeColumn pColumnA, DateTime pValue) {
