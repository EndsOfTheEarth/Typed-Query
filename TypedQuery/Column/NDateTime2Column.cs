...
namespace Sql.Column {
	...
	/// <summary>
	/// Nullable datetime2 column
	/// </summary>
	public class NDateTime2Column : AColumn {

		public NDateTime2Column(ATable pTable, string pColumnName)
			: base(pTable, pColumnName, false, true) {
		}
		public NDateTime2Column(ATable pTable, string pColumnName, bool pIsPrimaryKey)
			: base(pTable, pColumnName, pIsPrimaryKey, true) {
		}

		public static Condition operator ==(NDateTime2Column pColumnA, DateTime2Column pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(NDateTime2Column pColumnA, NDateTime2Column pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(NDateTime2Column pColumnA, DateTime pValue) {
		...
		public override object GetValue(ADatabase pDatabase, System.Data.Common.DbDataReader pReader, int pColumnIndex) {
			...
			if(dataType != typeof(DateTime) && dataType != typeof(DateTime?))
				throw new Exception("Row column data is not of the correct type. Expected DateTime or DateTime? value instead got '" + dataType.ToString() + "'. This probably means that the database and table column data types are not matching. Please run the definition tester to check table columns are of the correct type. Table: '" + Table.TableName + "' Column: '" + ColumnName + "'");
		...
		public override System.Data.DbType DbType {
			get { return System.Data.DbType.DateTime2; }
		}
