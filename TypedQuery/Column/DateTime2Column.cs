...
namespace Sql.Column {
    ...
    /// DateTime2 column
    /// </summary>
    public class DateTime2Column : AColumn {

        public DateTime2Column(ATable pTable, string pColumnName)
            : base(pTable, pColumnName, false, false) {
        }
        public DateTime2Column(ATable pTable, string pColumnName, bool pIsPrimaryKey)
            : base(pTable, pColumnName, pIsPrimaryKey, false) {
        }

        public static Condition operator ==(DateTime2Column pColumnA, DateTime2Column pColumnB) {
            return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
        }
        public static Condition operator ==(DateTime2Column pColumnA, NDateTime2Column pColumnB) {
            return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
        }
        public static Condition operator ==(DateTime2Column pColumnA, DateTime pValue) {
