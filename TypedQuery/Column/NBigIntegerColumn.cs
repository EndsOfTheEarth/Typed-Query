...
namespace Sql.Column {
	...
	/// </summary>
	public class NBigIntegerColumn : ANumericColumn {

		public NBigIntegerColumn(ATable pTable, string pColumnName)
			: base(pTable, pColumnName, false, true) {
		}
		public NBigIntegerColumn(ATable pTable, string pColumnName, bool pIsPrimaryKey)
			: base(pTable, pColumnName, pIsPrimaryKey, true) {
		}

		public static Condition operator ==(NBigIntegerColumn pColumnA, NBigIntegerColumn pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(NBigIntegerColumn pColumnA, BigIntegerColumn pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(NBigIntegerColumn pColumnA, Int64 pValue) {
		...
		public static NumericCondition<BigIntegerColumn, NBigIntegerColumn, Int64> operator +(NBigIntegerColumn pColumnA, NBigIntegerColumn pColumnB) {
			return new NumericCondition<BigIntegerColumn, NBigIntegerColumn, Int64>(pColumnA, NumericOperator.ADD, pColumnB);
		}
		public static NumericCondition<BigIntegerColumn, NBigIntegerColumn, Int64> operator +(NBigIntegerColumn pColumnA, BigIntegerColumn pColumnB) {
			return new NumericCondition<BigIntegerColumn, NBigIntegerColumn, Int64>(pColumnA, NumericOperator.ADD, pColumnB);
		}
		public static NumericCondition<BigIntegerColumn, NBigIntegerColumn, Int64> operator +(NBigIntegerColumn pColumnA, Int64 pValue) {
