...
namespace Sql.Column {
    ...
    public class NDoubleColumn : AColumn {

        public NDoubleColumn(ATable pTable, string pColumnName)
            : base(pTable, pColumnName, false, true) {
        }
        public NDoubleColumn(ATable pTable, string pColumnName, bool pIsPrimaryKey)
            : base(pTable, pColumnName, pIsPrimaryKey, true) {
        }

        public static Condition operator ==(NDoubleColumn pColumnA, NDoubleColumn pColumnB) {
            return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
        }
        public static Condition operator ==(NDoubleColumn pColumnA, DoubleColumn pColumnB) {
            return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
        }
        public static Condition operator ==(NDoubleColumn pColumnA, double pValue) {
        ...
        public static NumericCondition<DoubleColumn, NDoubleColumn, double> operator +(NDoubleColumn pColumnA, NDoubleColumn pColumnB) {
            return new NumericCondition<DoubleColumn, NDoubleColumn, double>(pColumnA, NumericOperator.ADD, pColumnB);
        }
        public static NumericCondition<DoubleColumn, NDoubleColumn, double> operator +(NDoubleColumn pColumnA, DoubleColumn pColumnB) {
            return new NumericCondition<DoubleColumn, NDoubleColumn, double>(pColumnA, NumericOperator.ADD, pColumnB);
        }
        public static NumericCondition<DoubleColumn, NDoubleColumn, double> operator +(NDoubleColumn pColumnA, double pValue) {
        ...
        public override object GetValue(ADatabase pDatabase, System.Data.Common.DbDataReader pReader, int pColumnIndex) {
            ...
            if(dataType != typeof(double) && dataType != typeof(double?)) {
                throw new Exception($"Row column data is not of the correct type. Expected double or double? value instead got '{ dataType.ToString() }'. This probably means that the database and table column data types are not matching. Please run the definition tester to check table columns are of the correct type. Table: '{ Table.TableName }' Column: '{ ColumnName }'");
            }
