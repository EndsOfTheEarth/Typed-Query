...
namespace Sql.Column {
	...
	public class ByteColumn : AColumn {

		public ByteColumn(ATable pTable, string pColumnName) : base(pTable, pColumnName, false, false) {
			
		}
		public ByteColumn(ATable pTable, string pColumnName, bool pIsPrimaryKey) : base(pTable, pColumnName, pIsPrimaryKey, false) {
			
		}		
		public ByteColumn(ATable pTable, string pColumnName, bool pIsPrimaryKey, bool pIsAutoId) : base(pTable, pColumnName, pIsPrimaryKey, false) {
			IsAutoId = pIsAutoId;
		}

		public static Condition operator ==(ByteColumn pColumnA, ByteColumn pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(ByteColumn pColumnA, NByteColumn pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(ByteColumn pColumnA, byte pValue) {
