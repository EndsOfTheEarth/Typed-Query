...
namespace Sql.Column {
	...
	public class IntegerColumn : ANumericColumn {

		public IntegerColumn(ATable pTable, string pColumnName)
			: base(pTable, pColumnName, false, false) {
		}
		public IntegerColumn(ATable pTable, string pColumnName, bool pIsPrimaryKey)
			: base(pTable, pColumnName, pIsPrimaryKey, false) {
		}
		
		public IntegerColumn(ATable pTable, string pColumnName, bool pIsPrimaryKey, bool pIsAutoId)
			: base(pTable, pColumnName, pIsPrimaryKey, false) {
			IsAutoId = pIsAutoId;
		}
		
		public static Condition operator ==(IntegerColumn pColumnA, IntegerColumn pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(IntegerColumn pColumnA, NIntegerColumn pColumnB) {
			return new ColumnCondition(pColumnA, Sql.Operator.EQUALS, pColumnB);
		}
		public static Condition operator ==(IntegerColumn pColumnA, int pValue) {
		...
		public static NumericCondition<IntegerColumn, NIntegerColumn, int> operator +(IntegerColumn pColumnA, IntegerColumn pColumnB) {
			return new NumericCondition<IntegerColumn, NIntegerColumn, int>(pColumnA, NumericOperator.ADD, pColumnB);
		}
		public static NumericCondition<IntegerColumn, NIntegerColumn, int> operator +(IntegerColumn pColumnA, NIntegerColumn pColumnB) {
			return new NumericCondition<IntegerColumn, NIntegerColumn, int>(pColumnA, NumericOperator.ADD, pColumnB);
		}
		public static NumericCondition<IntegerColumn, NIntegerColumn, int> operator +(IntegerColumn pColumnA, int pValue) {
