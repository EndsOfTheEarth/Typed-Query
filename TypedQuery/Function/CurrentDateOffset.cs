...
namespace Sql.Function {
	...
	public sealed class CurrentDateTimeOffset : ADateTimeFunction {

		private readonly DatabaseType mDatabaseType;

		public CurrentDateTimeOffset(DatabaseType pDatabaseType) {
		...
		public DateTimeOffset this[int pIndex, IResult pResult] {
			get {
				return (DateTimeOffset)pResult.GetValue(this, pIndex);
			}
		}
