namespace TypedQuery {
	partial class TableGeneratorForm {
		...
		private void InitializeComponent() {
			...
			this.txtTableDefinition.TabIndex = 8;
			...
			// 
			this.tabPageTableDefinition.Controls.Add(this.chkGenerateKeyTypes);
		...
		private System.Windows.Forms.CheckBox chkGenerateKeyTypes;
	}
}
